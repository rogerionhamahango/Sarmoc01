                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-none d-sm-inline-block">
                            <button type="button" class="btn header-item waves-effect"
                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="" src="assets/images/flags/mz_flag.png" alt="Header Language" height="16">
                            </button>
                        ...
                        <div class="dropdown d-inline-block user-dropdown">
                            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                                ...
                                <img class="rounded-circle header-profile-user" src="assets/images/users/avatar-1.jpg"
                                    alt="Header Avatar">
                                <span class="d-none d-xl-inline-block ms-1">Wellcome {{auth()->user()->fullname}}</span>
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a class="dropdown-item text-danger" href="{{route('destroy')}}"><i class="ri-shut-down-line align-middle me-1 text-danger"></i> Logout</a>
                            </div>
                        </div>
            ...
            <div class="vertical-menu">
                ...
                <div data-simplebar class="h-100">
                    ...
                    <div class="user-profile text-center mt-3">
                        ...
                        <div class="mt-3">
                            <h4 class="font-size-16 mb-1">{{auth()->user()->fullname}}</h4>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">Worker's register</h4>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">Worker's data</h4>
                                                ...
                                                <div class="tab-pane" id="seller-details">
                                                    <form method="POST" action="{{route('store2')}}" enctype="multipart/form-data">
                                                            ...
                                                            <div class="col-lg-6">
                                                                ...
                                                                <label>Academic level</label>
                                                                      <select class="form-select" name="academiclevel">
                                                                            ...
                                                                            <option value="M_SNE">Medium SNE</option>
                                                                            <option value="M_Prof">Medium profissional</option>
                                                                            <option value="Tec_Superior">High level school</option>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="submit"  class="btn btn-info w-20 waves-effect waves-light">
                                                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="text-sm-end d-none d-sm-block">
                                    Crafted with <i class="mdi mdi-heart text-danger"></i> by RNhamahango
                                </div>
                            </div>
                        </div>
                    </div>
