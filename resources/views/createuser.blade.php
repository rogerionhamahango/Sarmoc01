                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="text-center mt-4">
                            <div class="mb-3">
                                <a href="{{route('createuser')}}" class="auth-logo">
                                    <img src="assets/images/logo_rm.png" height="30" class="logo-dark mx-auto" alt="">
                                    <img src="assets/images/logo_rm.png" height="30" class="logo-light mx-auto" alt="">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="p-3">
                            <form class="form-horizontal mt-3" action="{{route('store1')}}" method="post">
                                @csrf
